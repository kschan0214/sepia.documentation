...
* Support Spherical Harmonic fitting with adjustable order of fitting
* Bug fix: running SEPIA without parrallel computing toolbox
* Bug fix: running MEDI toolbox nonlinear fit echo phase combination with less than 3 echoes
