...
- Gain experience to correct the phase data
...
Let's take a look of the magnitude images. You can do that by calling the image viewer FSLeyes with:

``fsleyes mag.nii.gz``

Once you opened the magnitude images in the viewer, click the movie button to see how the brain images change over time. You can also press ``ctr+3`` to see the plot of signal evolution at different brain tissues. Select a few data points in the brain, how do you describe the signal curve? 

[Click here to check if you follow the instruction]()
...
Go the **Phase unwrapping** tab and you will see two panels under the tad: the **I/O** is for data input and output and the **Total field recovery and phase unwrapping** is for true phase accumulation estimation.
...
.. math::
   ...
   frequency = phase / time [2]

[Proceed to Exercise 2](https://github.com/kschan0214/sepia/wiki/(f)MRI-Toolkit-2019-Exercise-2)