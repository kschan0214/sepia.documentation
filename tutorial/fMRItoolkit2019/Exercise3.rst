...
4. Compare the location of the edges of brain structures with what you can see in the mean magnitude image computed in Exercise 1.
  ...
  #. Use shortcut ``Crtl+A`` in the FSLView to add *mag_mean.nii.gz* to the currently displayed local field maps.
  ...
  #. It is known that there is high concentration of iron deposition in the globus pallidus. There it generated a strong secondary magnetic field. Can you identify the magnetic field generated by this structure?
...
#. Use FSLView to display the local field map (Hz) when using 'Peel' value of 2 (should be in *~/qsm_tutorial/data/output_localfield/*):
  ...
  iii. Check/Uncheck the 'Visibility' button in the buttom of the viewer to turn on/off of the top image. What are the main differences between the two results?
