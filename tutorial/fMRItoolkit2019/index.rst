...
.. figure:: images/qsm_ref.png
   ...
   Figure 1: A QSM map. Deep gray matter structures such as Globus Pallidus containing high iron concentration is bright while white matter, which is myelin-rich, is dark. Studies has shown that the magnetic susceptibility values in deep gray matter is highly correlated with iron staining histology result.
...
.. figure:: images/qsm_model_flow.png
   ...
   Figure 2: The QSM thoery is summarised in the flowchart. 
...
Let's follow the exercises to know more about some QSM knowledge and processing techniques:
